...
ProposalsComponent = __decorate([
    core_1.Component({
        ...
        template: "<esl-proposal-list #proposalList (onEdit)=\"onEditClick($event)\" (onDelete)=\"onDeleteClick($event)\"></esl-proposal-list><div class=\"modal fade\" id=\"myModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\"><div class=\"modal-dialog\" role=\"document\"><div class=\"modal-content\"><div class=\"modal-header\"><button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button><h4 class=\"modal-title\" id=\"myModalLabel\">Edit Porposal:</h4></div><div class=\"modal-body\"><esl-proposal-edit [proposalId]=\"proposalEditId\" (onSubmit)=\"onEditedProposalSubmitted($event)\"></esl-proposal-edit></div></div></div></div>",
        styles: [""]
    }),
